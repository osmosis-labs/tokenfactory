...
var (
	...
	pattern_Query_DenomAuthorityMetadata_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 2, 4}, []string{"osmosis", "tokenfactory", "v1beta1", "denoms", "authority_metadata"}, "", runtime.AssumeColonVerbOpt(false)))
